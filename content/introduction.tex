...
%This has the obvious advantage that the Verifier can no longer reuse the credential to impersonate the user and that anonymous credentials allow the users to reveal only a subset of her attributes.
...
%\footnote{Identity Mixer - \url{https://www.research.ibm.com/labs/zurich/idemix/}}, %broken url
